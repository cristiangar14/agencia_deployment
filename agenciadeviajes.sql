...
INSERT INTO `testimoniales` VALUES (1,'cristian','correo@correo.com','prueba'),(6,'Matias','matias@correo.com','Usa un diccionario de mas de 200 palabras provenientes del latín, combinadas con estructuras muy útiles de sentencias, para generar texto de Lorem Ipsum que parezca razonable. Este Lorem Ipsum generado siempre estará libre de repeticiones, humor agregado o palabras no características del lenguaje, etc'),(7,'Nana','nana@cooreo.com','El trozo de texto estándar de Lorem Ipsum usado desde el año 1500 es reproducido debajo para aquellos interesados. Las secciones 1.10.32 y 1.10.33 de \"de Finibus Bonorum et Malorum\" por Cicero son también reproducidas en su forma original exacta, acompañadas por versiones en Inglés de la traducción realizada en 1914 por H. Rackham.'),(8,'Maribel','maribel@correo.com','esto es una prueba'),(9,'Maribel','maribel@correo.com','esto es otra prueba despues de modificar routs'),(10,'Cristian','cristian@correo.com','prueba con async'),(11,'Mati','correo@correo.com','esto es una prueba despues del  .env');
...
-- Dump completed on 2020-06-08 21:37:28
